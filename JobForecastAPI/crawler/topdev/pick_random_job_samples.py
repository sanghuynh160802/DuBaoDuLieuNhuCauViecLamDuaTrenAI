...
# Input and output file paths
input_txt = r"D:\SANG\Do An Tot Nghiep\crawl-data\data\data_topdev\topdev_jobUrls_01.txt"
output_txt = r"D:\SANG\Do An Tot Nghiep\crawl-data\data\data_topdev\random_job_urls_topdev.txt"
