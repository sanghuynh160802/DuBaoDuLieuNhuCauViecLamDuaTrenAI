...
# Input and output file paths
input_txt = r"D:\SANG\Do An Tot Nghiep\WEB-THAMKHAO\JOBINFOR\JobForecastAPI\job-urls\itviec\itviec_jobUrls.txt"
output_txt = r"D:\SANG\Do An Tot Nghiep\WEB-THAMKHAO\JOBINFOR\JobForecastAPI\job-urls\itviec\random_job_urls_itviec.txt"
...
# Pick 10 random URLs
import random
sampled_urls = random.sample(urls, 5)
